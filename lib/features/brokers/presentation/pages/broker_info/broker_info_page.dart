...
//     if (brokerId != null) {
//       final BrokersListEntity brokersData =
//           Provider.of<BrokersListEntity>(context, listen: false);

//       brokerData = brokersData.brokers.where((element) => element.key == widget.brokerId);
